...
// Persona naming: the product is "FastWorker"; the personas are a "Coworker" family — Coworker
...
// API + tests keep "FastWorker" / "Ops Coworker"); this is purely the display layer.
