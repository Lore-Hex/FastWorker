...
uploads):
    ...
    FastWorker-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    FastWorker-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
`releases/latest/download/latest.json` URL configured in
...
ARTIFACTS = {
    "FastWorker-macos-arm64.app.tar.gz": "darwin-aarch64",
    "FastWorker-windows-setup.exe": "windows-x86_64",
}
