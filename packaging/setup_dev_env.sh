...
# fastworker-server directly, and the Tauri desktop shell falls back to the
# compatibility sidecar executable when
...
echo "Ready: $VENV"
echo "  server: $VENV/bin/fastworker-server --cwd /path/to/your/project --port 8765"
